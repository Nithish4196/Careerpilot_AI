...
export const ROUND_ICONS: Record<RoundType, React.ElementType> = {
  "Aptitude": Puzzle,
...
export const ROUND_DESCRIPTIONS: Record<RoundType, string> = {
  ...
  "Group Discussion": "AI simulates other candidates, topic-based discussion",
  "Coding": "Live code editor, DSA problems",
  "Technical": "Core technical questions for your role",
...
export const TECH_FRONTEND = [
  "Explain the virtual DOM and how React uses it.",
  "What is the difference between useEffect and useLayoutEffect?",
  "How does CSS specificity work?",
  "What are closures in JavaScript?",
  "Explain the event loop in JavaScript.",
  "What is SSR and when would you use Next.js?"
];
...
export const TECH_DATA = [
  ...
  "Explain what an index is and when you'd use one."
];

export const TECH_BACKEND = [
...
export const TECH_DEFAULT = [
  "Explain the concept of OOP with a real-world example.",
  "What is time complexity? Give examples of O(n) and O(n²).",
  "What is the difference between stack and heap memory?",
  "Explain what an API is and how HTTP works.",
...
export const GD_TOPICS = [
  ...
  "Is college education still relevant in 2025?"
];
