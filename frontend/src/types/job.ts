...
const baseMockJobs: Job[] = [
  {
    ...
    responsibilities: ["Acquire data from primary or secondary data sources and maintain databases/data systems","Identify, analyze, and interpret trends or patterns in complex data sets","Filter and 'clean' data by reviewing computer reports, printouts, and performance indicators"
    ],
    benefits: ["Comprehensive Health Insurance","Flexible hybrid work schedule","Performance bonus"
    ],
  ...
  },
  {
    ...
    responsibilities: ["Write client-side code for web-based applications","Develop prototypes quickly","Build fast and efficient next-generation web applications"
    ],
    benefits: ["Free meals and snacks","Top-tier health coverage","Generous equity package"
    ],
  ...
  },
  {
    ...
    responsibilities: ["Design, build, and maintain APIs, services, and systems across Stripe's engineering teams","Debug production issues across services and multiple levels of the stack","Improve engineering standards, tooling, and processes"
    ],
    benefits: ["Fully remote work environment","Home office stipend","Wellness allowance"
    ],
  ...
  },
  {
    ...
    responsibilities: ["Develop both client-side and server-side software","Build APIs and integrate third-party services","Ensure cross-platform optimization for mobile phones"
    ],
    benefits: ["Comprehensive Training","Health coverage","Performance bonus"
    ],
  ...
  },
  {
    ...
    responsibilities: ["Analyze and solve business problems at their root","Design and develop metrics, reports, and dashboards","Collaborate with engineering teams to build data pipelines"
    ],
    benefits: ["Health, dental, and vision insurance","Paid time off","Employee discount"
    ],
